        ...
        <div className={s.app}>
          <Switch>
            <Route
              exact
              path="/"
              component={() => <MainPageFoodCasino {...mediaQueries} />}
            />
            <Route
              path="/klassicheskoe-kazino"
              component={() => <ClassicCasino {...mediaQueries} />}
            />
            <Route
              path="/cart"
              component={() => <CartPage {...mediaQueries} />}
            />
            <Route
              path="/contacts"
              component={() => <ContactsPage {...mediaQueries} />}
            />
            <Route
              path="/croupiers"
              component={() => <PageCroupiers {...mediaQueries} />}
            />
            <Route
              exact
              path="/news"
              component={() => <PageNews {...mediaQueries} />}
            />
            <Route
              path="/news/:id"
              component={() => <PageNewsItem {...mediaQueries} />}
            />
            {foodCasinos.map((casino, index) => (
              <Route
                ...
                key={index}
                component={() => (
                  <WineCasino casino={casino} {...mediaQueries} />
                )}
              />
            ))}
